...
```
java -Dspring.profiles.active=production -jar ./target/my-tiendita-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=io.bootify/my-tiendita
```
